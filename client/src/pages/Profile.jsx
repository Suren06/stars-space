    ...
    <div className="max-w-lg p-3 mx-auto">
      ...
      <div className="flex justify-between mt-4">
        <span
          ...
          className="p-2 text-red-600 rounded-lg cursor-pointer hover:text-red-700 hover:bg-red-100 hover:underline"
        >
          Delete account?
        </span>
        <span
          onClick={handleSignout}
          className="p-2 text-red-600 rounded-lg cursor-pointer hover:underline hover:text-red-700 hover:bg-red-100"
        >
          Sign out
        </span>
      </div>
